...
WebUI.setText(findTestObject('Object Repository/Case_53/Page_Nabe Eats/input_Enter Mobile Number_mobile'), '240-345-1599')
...
WebUI.click(findTestObject('Case_51/Page_Mindboard Holdings LLC/button_Check out as guest'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Case_53/Page_Nabe Eats/h4_45.76'), '₹45.76')
